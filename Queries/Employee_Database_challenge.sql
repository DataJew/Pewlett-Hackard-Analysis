...
-- Update the code block to create a new table
SELECT COUNT(ce.emp_no), de.dept_no
...
-- Check the table, then export is as a CSV
...
WHERE (e.birth_date BETWEEN '1952-01-01' AND '1955-12-31')
     AND (e.hire_date 
		  BETWEEN '1985-01-01' AND '1988-12-31')
	 AND (de.to_date = '9999-01-01');

SELECT * FROM emp_info;

-- drop tables for Module 7 Challenge
